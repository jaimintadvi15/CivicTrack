...
import { CivicReport, ReportCategory, SeverityLevel, Ward } from '../types';
...
export const CitizenReportFlow: React.FC<CitizenReportFlowProps> = ({
  ...
  const [reporterName, setReporterName] = useState<string>('Marcus Vance');
  const [reporterPhone, setReporterPhone] = useState<string>('(555) 382-9912');
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-4 sm:p-5 space-y-3.5 shadow-xs">
            ...
            <div
              ...
              className={`relative rounded-lg border-2 border-dashed transition-all overflow-hidden flex flex-col items-center justify-center min-h-[200px] ${
                isDragging
              ...
              {photoUrl ? (
                ...
                <div className="p-6 text-center">
                  ...
                  <p className="text-xs text-slate-700 font-semibold">
                    Drag &amp; drop issue photo here, or browse files
                  </p>
                  <p className="text-[11px] text-slate-500 mt-1">
                    Accepts JPEG, PNG &bull; Auto-extracts GPS EXIF if enabled
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex-1 py-2 rounded-lg bg-white hover:bg-slate-50 border border-slate-300 text-xs font-mono text-slate-700 hover:text-slate-900 transition-colors flex items-center justify-center gap-1.5 shadow-xs"
              >
